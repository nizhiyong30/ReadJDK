...
public class DateUtil {
    public static void main(String[] args) throws Exception{
        ...
        String statisticHourDate = DateUtil.DateToString(statisticDate, "yyyyMMddHH");

        // 获取上上个小时
        calendar.set(Calendar.HOUR_OF_DAY, calendar.get(Calendar.HOUR_OF_DAY) - 1);

        String checkHourStr = DateUtil.DateToString(calendar.getTime(), "yyyyMMddHH");
//			Date checkHour = GCNTConstant.HOUR_SDF.parse(GCNTConstant.HOUR_SDF.format(calendar.getTime()));
        Date checkHour = DateUtil.StringToDate(checkHourStr, "yyyyMMddHH");
        System.out.println(checkHourStr);
    }

    public static final String DATE_PARTEN = "yyyy-MM-dd HH:mm:ss";
    public static final String DAY_PARTEN = "yyyy/MM/dd";
    public static final String HOUR_PARTEN ="HH";
     ...
     * 线程安全格式化 Date -> String
     */
    public static String safeFormatDate(long timestamp) {
        return getFormat().format(new Date(timestamp));
    }
     ...
     * @return 相差豪秒数
     */
    public static long getIntervalDays(long longDate, long otherLongDate) {
        long time = Math.abs(longDate - otherLongDate);
        return time;
    }

    public static int getDateInteger(Date date) {
        String endYear = getYear(date) + "";
        String endMonth = getMonth(date) + "";
        String endDay = getDay(date) + "";
        int endTime = Integer.parseInt(endYear + endMonth + endDay);
        return endTime;
    }

    public static Date formatDate2yyyyMMddHH(Date date) {
    ...
    public enum DateStyle {
        ...
        MM_DD("MM-dd"), YYYY_MM("yyyy-MM"), YYYY_MM_DD("yyyy-MM-dd"), MM_DD_HH_MM("MM-dd HH:mm"), MM_DD_HH_MM_SS(
                "MM-dd HH:mm:ss"), YYYY_MM_DD_HH("yyyy-MM-dd HH"), YYYY_MM_DD_HH_MM(
